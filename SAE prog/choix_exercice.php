...
<body>
    ...
    <div class="nav-container">
      ...
      <nav>
        <ul class="nav-list">
            ...
            <a href="deconnexion.php" class="bn14">Déconnexion</a>
            <a href="admin.php" class="bn14">Admin</a>
  ...
  <div class="popup">
    ...
    Bonjour <strong><?php echo htmlentities(trim($_SESSION['pseudo']) ); ?> </strong> </h3> nous sommes heureux de vous revoir, lors de votre dernière session vous vous êtes arreté à l'exercice numéro <strong><?php echo htmlentities(trim($_SESSION['exo']) ); ?> </strong>.Nous espérons que notre site vous permettra d'apprendre de nombreuses choses !
    </p>
