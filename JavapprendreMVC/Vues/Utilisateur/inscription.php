...
<head>
    ...
    <div class="col-md-6 well">
        ...
        <a href="index.php?url=Utilisateur/connexion">Déjà inscrit ? Se connecter...</a>
        <br style="clear:both;" /><br />
        <div class="col-md-3"></div>
        <div class="col-md-6">
            <!-- Formulaire d'inscription -->
            <form method="POST" name="myForm" onsubmit="return validateForm();" action="index.php?url=Utilisateur/traitementInscription">
